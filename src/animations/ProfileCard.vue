...
.pc-card {
  ...
  background-image:
    ...
    radial-gradient(35% 52% at 55% 20%, #fff 0%, #073aff00 100%),
    radial-gradient(100% 100% at 50% 50%, #fff 1%, #073aff00 76%),
    conic-gradient(from 124deg at 50% 50%, #fff 0%, #fff 40%, #fff 60%, #c137ffff 100%);
  overflow: hidden;
}
...
.pc-details h3 {
  ...
  margin: 0;
  background-image: linear-gradient(to bottom, #000, #5c10db);
